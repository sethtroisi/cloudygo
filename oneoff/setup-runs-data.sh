...
sqlite3 instance/clouds.db """
    INSERT INTO RUNS VALUES
        ...
        ('cross-run-eval', 'cross-run-eval', 'Eval games between minigo runs',
            0, 0),
        ('leela-zero-v1', 'leela-zero', 'Leela-Zero (games up to LZ124)',
            0, 0),
        ('leela-zero-v2', 'leela-zero official eval', 'Leela-Zero (official eval games up to LZ180)',
            0, 0),
        ('leela-zero-v3', 'leela-zero eval', 'Leela-Zero (eval up to LZ201)',
            0, 0),
        ('leela-zero-v4', 'leela-zero time eval', 'Leela-Zero (time based eval up to LZ201)',
            0, 0),
